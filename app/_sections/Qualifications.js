      ...
      <div className="content">
        ...
        <Slider>
          <SliderItems>
            ...
            <SliderItem hours="69" image="javascript" name="The complete javascript course 2022: from Zero to expert!" />
            <SliderItem hours="42" image="nodejs" name="Node.js, Express, MongoDB & More: The complete bootcamp 2022" />
            <SliderItem hours="84" image="react" name="The Ultimate React Course: React, Redux, Next.js & More" />
